...
const GAMES = [
  ...
  { id: 'unity-zombiestoro', name: 'ZOMBIES TORO', icon: '🧟', color: '#66ff33', desc: 'Shooter 3D con movimiento libre, oleadas, audio tematico y controles tactiles.', type: 'unity', url: 'unity/zombiestoro/index.html?v=20260711-4' },
];
